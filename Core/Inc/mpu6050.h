...
/** @brief 芯片地址 */
/** @brief MPU6500 WHO_AM_I 返回值为 0x70，MPU6050 为 0x68 */
...
#define MPU6050_REG_SIG_PATH_RESET   0x68U
...
/** @brief 加速度计量程 */
typedef enum {
    MPU6050_ACCEL_RANGE_2G  = 0x00U,    /**< ±2g  */
    MPU6050_ACCEL_RANGE_4G  = 0x08U,    /**< ±4g  */
    MPU6050_ACCEL_RANGE_8G  = 0x10U,    /**< ±8g  */
    MPU6050_ACCEL_RANGE_16G = 0x18U,    /**< ±16g */
} MPU6050_AccelRange_t;

/** @brief 陀螺仪量程 */
typedef enum {
    MPU6050_GYRO_RANGE_250DPS  = 0x00U, /**< ±250 °/s  */
    MPU6050_GYRO_RANGE_500DPS  = 0x08U, /**< ±500 °/s  */
    MPU6050_GYRO_RANGE_1000DPS = 0x10U, /**< ±1000 °/s */
    MPU6050_GYRO_RANGE_2000DPS = 0x18U, /**< ±2000 °/s */
} MPU6050_GyroRange_t;
