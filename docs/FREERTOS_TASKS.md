...
| TaskTelemetry | StartTaskTelemetry | 10ms | 320 | Low | 遥测帧上报 (100Hz) |
...
[f0] M1 speed_ref (RPM)   [f1] M1 speed_fb (RPM)
[f2] M1 iq_ref (A)        [f3] M1 iq (A)
[f4] M2 speed_ref (RPM)   [f5] M2 speed_fb (RPM)
[f6] M2 iq_ref (A)        [f7] M2 iq (A)
```
